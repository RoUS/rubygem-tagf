...
module TAGF
  ...
  # Module containing stuff for loading/importing/exporting/saving
  # game information.
  module Filer
    ...
    # from YAML files.
    #
    # Some game objects include direct references, or 'contain,'
    # others.  For example, inventories or the connexions between
    # locations.  Relationships are via EIDs (Element IDs).  We can't
    # put something into an object until the thing has been created,
    # so we store all these in 'pending' lists until all the objects
    # have been reified.  Then we stitch them together from the
    # 'pending' BOM lists.
    #
    ...
    class Loader
      ...
      # An array of the game element objects created by the #load_game
      # method.
      #
      # @return [Array<TAGF::Mixin::Element>]
      ...
      def load_game(file)
        ...
        #
        # For each type of object we load, check loadable fields,
        # merged from
