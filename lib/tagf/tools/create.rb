...
=begin
global options  --source=foo.yml --output=bar.yml
create game EID [options]
create location EID [options]
create path EID --origin=EID --destination=EID [options]
create item EID [options]
create keyword EID [options]
=end

TAGF::CLI.subcommand('help create') do |cdef,**opts|
  cdef.summary('Create game elements from the command line.')
...
TAGF::CLI.command('create') do |cdef,**opts|
  
  cdef.summary('Create a game from the command line.')
  cdef.usage('create [options] EID')
...
*   create --source=foo.yml  "foo"

will produce an output file named `foo.yml`.
  EOT
...
TAGF::CLI.subcommand('create game') do |cdef,**opts|
  cdef.summary('Create a new game definition file.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
    Errno::NOERROR.new.errno
...
TAGF::CLI.subcommand('create faction') do |cdef,**opts|
  cdef.summary('Create a new faction for a game.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
    Errno::NOERROR.new.errno
...
TAGF::CLI.subcommand('create feature') do |cdef,**opts|
  cdef.summary('Create a new feature for a game.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
    Errno::NOERROR.new.errno
...
TAGF::CLI.subcommand('create item') do |cdef,**opts|
  cdef.summary('Create a new item for a game.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
    Errno::NOERROR.new.errno
...
TAGF::CLI.subcommand('create keyword') do |cdef,**opts|
  cdef.summary('Create a new game definition file.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
...
TAGF::CLI.subcommand('create location') do |cdef,**opts|
  cdef.summary('Create a new game location.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
    Errno::NOERROR.new.errno
...
TAGF::CLI.subcommand('create npc') do |cdef,**opts|
  cdef.summary('Create a new NPC (non-player character) for a game.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
    Errno::NOERROR.new.errno
...
TAGF::CLI.subcommand('create path') do |cdef,**opts|
  cdef.summary('Create a new game definition file.')
  cdef.run do |opts,args,cmd|
    subcmd		= [cmd.name, *args].compact.join('~')
    puts(Commands[subcmd].help)
